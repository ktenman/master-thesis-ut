...
\captionsetup{font=footnotesize} % You can use footnotesize, small, or scriptsize as desired
...
% Packages for defining colorful text together with some colors
\usepackage{color}
\usepackage{xcolor} 

% Define the colors used in the document
\definecolor{dkgreen}{rgb}{0,0.6,0} % This defines the dkgreen color
\definecolor{gray}{rgb}{0.5,0.5,0.5}
\definecolor{mauve}{rgb}{0.58,0,0.82}

% Load Inconsolata font for code snippets
\usepackage{inconsolata}
\usepackage{adjustbox}

% Proper way to create colored code listings
\usepackage{listings}
...
\lstset{ 
  ...
  basicstyle=\tiny\ttfamily,    % the size and font of the code
  numberstyle=\tiny\color{gray}, 
...
\newcommand{\thesistitle}{AI-Powered MMSE: Enhancing Cognitive Assessment}
\newcommand{\thesistitleET}{Tehisintellektil põhinev MMSE: Kognitiivse hindamise täiustamine}
\newcommand{\supervisor}{Mohamad Gharib}
\newcommand{\supervisordr}{Dr. \supervisor}
\newcommand{\supervisorphd}{\supervisor, PhD}
